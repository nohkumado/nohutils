...
import eu.nohkumado.nohutils.ColumPrinter;
...
public class LsCommand extends FileExpandCommand implements Cloneable, CommandI
{
	...
	public String execute()
	{
		...
		String error = "";
		if (!theDir.exists()) error = shell.msg(com.nohkumado.nohutils.R.string.cd_does_not_exist);
		if (!theDir.canRead()) error = shell.msg(com.nohkumado.nohutils.R.string.ls_not_enough_rights) + " " + theDir;

		if ("".equals(error) && theDir.exists() && theDir.isDirectory())
		{
