...
import eu.nohkumado.nohutils.foreign.ShellTextWatcher;
import eu.nohkumado.nohutils.view.LoggerFrag;
...
public class Shell implements ShellI, OnEditorActionListener, OnKeyListener
{
  ...
  public boolean init()
  {
    ...
    if(screenContent != null && screenContent.size() <= 0)
  ...
  @Override
  public int intPref(String key) throws FileNotFoundException
  {
  ...
  @Override
  public float floatPref(String key) throws FileNotFoundException
  {
    if(context == null) throw new FileNotFoundException(" no context");
    SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences((Context) context);
    if(prefs.contains(key))
  ...
  @Override
  public long longPref(String key) throws FileNotFoundException
  {
    if(context == null) throw new FileNotFoundException(" no context");
    SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences((Context) context);
    if(prefs.contains(key))
  ...
  @Override
  public boolean booleanPref(String key) throws FileNotFoundException
  {
    if(context == null) throw new FileNotFoundException(" no context");
    SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences((Context) context);
    if(prefs.contains(key))
  ...
  @Override
  public Set<String> stringSetPref(String locname)
  {
    if(context == null) return null;
    SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences((Context) context);
    return prefs.getStringSet(locname,null);
  }
   ...
   * executeCommands
   *
   * @param toWorkOf cycle over list and execute the stored commands, i think not thread safe...
   */
